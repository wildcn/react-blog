...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('公司成立时间', 'options_framework_theme'),
		'desc' => __('2012-01-01', 'options_framework_theme'),
		'id' => 'company_start_time',
		'std' => '2012-01-01',
		'class' => 'mini',
		'type' => 'text');
	$options[] = array(
		'name' => __('淘宝网店主页地址', 'options_framework_theme'),
		'desc' => __('请填写移动端网址', 'options_framework_theme'),
		'id' => 'taobao_address',
		'std' => 'http://taobao.com',
		'type' => 'text');
	$options[] = array(
		'name' => __('联系方式', 'options_framework_theme'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('固定电话', 'options_framework_theme'),
		'desc' => __('公司固定电话', 'options_framework_theme'),
		'id' => 'contact_phone',
		'std' => '010-11111111',
		'type' => 'text');

	$options[] = array(
		'name' => __('咨询电话', 'options_framework_theme'),
		'desc' => __('手机', 'options_framework_theme'),
		'id' => 'contact_mobile',
		'std' => '400-110-1221',
		'type' => 'text');
	$options[] = array(
		'name' => __('400电话', 'options_framework_theme'),
		'desc' => __('400电话', 'options_framework_theme'),
		'id' => 'contact_400',
		'std' => '400-4313-861',
		'type' => 'text');
	$options[] = array(
		'name' => __('400电话说明', 'options_framework_theme'),
		'desc' => __('400电话说明', 'options_framework_theme'),
		'id' => 'contact_400_txt',
		'std' => '全国免费 客户热线',
		'type' => 'text');
	$options[] = array(
		'name' => __('微信公众账号', 'options_framework_theme'),
		'desc' => __('公众号名称', 'options_framework_theme'),
		'id' => 'contact_wechat_name',
		'std' => '清新全家除醛',
		'type' => 'text');
	$options[] = array(
		'name' => __('二维码地址', 'options_framework_theme'),
		'desc' => __('选择媒体库或上传', 'options_framework_theme'),
		'id' => 'contact_wechat_qrcode',
		'type' => 'upload');
	...
	// 	'desc' => __('选择首页左侧新闻列表所属目录', 'options_framework_theme'),
	// 	'id' => 'news_list_left',
	// 	'type' => 'select',
	...
	// $options[] = array(
	// 	'name' => __('选择分类', 'options_framework_theme'),
	// 	'desc' => __('选择首页右侧新闻列表所属目录', 'options_framework_theme'),
	// 	'id' => 'news_list_right',
	// 	'type' => 'select',
	// 	'options' => $options_categories);
	...
	$options[] = array(
		'name' => __('网站版权声明', 'options_framework_theme'),
		'desc' => __('网站最下方的版权声明', 'options_framework_theme'),
		'id' => 'copyright',
		'std' => 'Copyright © 2015 QingXinQuanJia. All Rights Reserved',
		'type' => 'textarea');


	$options[] = array(
		'name' => __('最新文章屏蔽指定栏目', 'options_framework_theme'),
		'desc' => __('31,11', 'options_framework_theme'),
		'id' => 'category_not_in',
		'std' => '2012-01-01',
		'class' => 'mini',
		'type' => 'text');
